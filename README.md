...
╭╯ ytpt - YouTube Playlist Tracker ╰──────────────────────────────────────────────────────╮
│╭───────────────────────────╮╭──────────────────────────────────────────────────────────╮│
││ Playlists                 ││ Videos (Favorites) [3] | synced: never                   ││
││ [x] Favorites             ││ #    Title                Channel          Added ▼ Status ││
││ [x] Music                 ││ ──────────────────────────────────────────────────────── ││
││                           ││ 1    Never Gonna Give Y.. Rick Astley      2024-03-01 Active ││
││                           ││ 2    Bohemian Rhapsody    Queen            2024-02-01 Active ││
││                           ││ 3    Imagine              John Lennon      2024-01-01 Active ││
│╰───────────────────────────╯╰──────────────────────────────────────────────────────────╯│
│ p profiles │ / F3 search │ o F4 sort │ F8 deleted │ Enter detail │ h/l pane │ j/k nav   │
│ e F7 export │ H F11 hist │ F9 settings │ p profile │ ? F12 help │ q quit                │
╰─────────────────────────────────────────────────────────────────────────────────────────╯
```

*Captured from an actual TUI snapshot test. Profile pane appears when multiple Google accounts are configured (toggle with `p`).*
